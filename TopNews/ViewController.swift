...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, FilterViewControllerDelegate, UISearchBarDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var ascendingSortDirection = true
...
/*
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let newsCell = cell as? NewsCellTableViewCell else { return cell }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let newsCell = cell as? NewsCollectionViewCell else { return cell }
    ...
    @IBAction func sortItems(_ sender: Any) {
        newsArray.sort { (aNews, bNews) -> Bool in
            if self.ascendingSortDirection {
                return aNews.publishedAt < bNews.publishedAt
            }
            return aNews.publishedAt > bNews.publishedAt
        }
        applyFilter()
        self.ascendingSortDirection = !self.ascendingSortDirection
        self.sortBarButton.title = "sort " + (self.ascendingSortDirection ? "+ " : "-")
    }
}
